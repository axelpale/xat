...
module.exports = function (accounts, events) {
  ...
  // For income tax.
  printByYear(events, 'income', 'Ordinary Income by Year')
  // For received gifts.
  printByYear(events, 'giftIn', 'Received Gifts by Year')
  // For sales
  printByYear(events, 'sale', 'Capital Gain from Sales by Year')
  // For rewards
  printByYear(events, 'gain', 'Capital Gain from Staking Rewards by Year')
