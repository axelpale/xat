...
exports.FIFO_ORDER = String(config.FIFO_ORDER).toLowerCase()
exports.LOCALE = String(config.LOCALE).toLowerCase()

exports.REPORTS_EXCLUDE_ACCOUNTS = config.REPORTS_EXCLUDE_ACCOUNTS

const displayZero = Boolean(config.REPORTS_DISPLAY_ZERO_BALANCE)
exports.REPORTS_DISPLAY_ZERO_BALANCE = displayZero
