...
module.exports = function (row, accounts, events) {
  ...
  const feeUnitPriceEur = row.feeUnitValueEur
  ...
  if (sourceUnit === 'EUR') {
    ...
    // Add the fees as sale expenses. Fees are not included in the sent
    // assets but their possible capital gain must be handled already.
