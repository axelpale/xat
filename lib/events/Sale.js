...
const Sale = function (
  ...
  //     a string
  //   soldFromAccount
  //     a string, the source account name
  //   documents
  //     an array of strings
  //
  if (typeof id !== 'number') {
  ...
  if (!soldFromAccount || typeof soldFromAccount !== 'string') {
    throw new Error('Invalid account for sold assets. Must be a string.')
  }
  ...
  this.soldFromAccount = soldFromAccount
...
proto.getReportData = function () {
  ...
  for (let i = 0; i < len; i++) {
    ...
    assetSales.push({
      ...
      soldUnit: asset.unit,
      soldFromAccount: this.soldFromAccount,
      ...
      capitalGainOrLossTotalEur: capitalGain.minus(capitalLoss)
    })
  }
